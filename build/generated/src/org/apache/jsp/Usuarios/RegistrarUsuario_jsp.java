...
public final class RegistrarUsuario_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/Usuarios/../plantilla.jsp");
  }
...
if (request.getAttribute("mensajeExito") != null) {
      ...
      out.write("                <a  href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/Usuarios/ConsultarUsuario.jsp\"><div class=\"btn btn-success\" style=\"width: 60%; margin: auto\">\n");
      out.write("                        ");
      ...
      out.write("            <br>\n");
      out.write("\n");
      out.write("            <div  id=\"formularioCliente\" class=\"shadow-lg p-3 mb-5 bg-white rounded\" style=\"height: 1050px\">\n");
      out.write("                <form action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/Usuario\" method=\"post\">\n");
      out.write("                    <div class=\"card-header\">\n");
      out.write("                        <h1 style=\"text-align: center;\"><b> Registro Usuario </b></h1><br>\n");
      out.write("                    </div>\n");
      out.write("\n");
      out.write("\n");
      out.write("                    <div class=\"card-body\">\n");
      out.write("                        <!-- Numero Documento -->  \n");
      out.write("                        <label id=\"lb1\" class=\"label\">Numero Documento</label>\n");
      out.write("                        <input id=\"txtDocumento\" name=\"Cedula\" type=\"text\" minlength=\"8\" name=\"text\" onkeyup=\"quitar();\" minlength=\"8\" placeholder=\"Digite su numero de documento\" class=\"form-control txt\" >\n");
      out.write("                        <div id=\"error1\" class=\"errores  \"> Debe digitar su Numero de documento</div>\n");
      out.write("                        <div id=\"error11\" class=\"errores  \"> Solo se permiten numeros</div><br><br>\n");
      out.write("\n");
      out.write("\n");
      out.write("                        <!-- Nombre -->     \n");
      out.write("                        <label id=\"lb3\" class=\"label\">Nombre</label>\n");
      out.write("                        <input type=\"text\" name=\"Nombre\" id=\"txtNombre\" name=\"text\" onkeyup=\"quitar();\"  placeholder=\"Digite su nombre\" class=\"form-control txt\">\n");
      out.write("                        <div id=\"error3\" class=\"errores  \"> Debe digitar su Nombre</div>\n");
      out.write("                        <div id=\"error33\" class=\"errores  \"> Solo se permiten letras</div><br><br>\n");
      out.write("\n");
      out.write("                        <!-- Apellido -->     \n");
      out.write("                        <label id=\"lb4\" class=\"label\">Apellido</label>\n");
      out.write("                        <input type=\"text\" name=\"Apellido\" id=\"txtApellido\" onkeyup=\"quitar();\" placeholder=\"Digite su apellido\" name=\"text\"  class=\"form-control txt\">\n");
      out.write("                        <div id=\"error4\" class=\"errores  \"> Debe digitar su Apellido</div>\n");
      out.write("                        <div id=\"error44\" class=\"errores  \"> Solo se permiten letras</div><br><br>\n");
      out.write("\n");
      out.write("                        <!-- Celular -->     \n");
      out.write("                        <label id=\"lb5\" class=\"label\">Celular</label>\n");
      out.write("                        <input id=\"txtcelular\" name=\"Celular\" type=\"text\" minlength=\"8\" name=\"text\" onkeyup=\"quitar();\" placeholder=\"Digite su celular\"  class=\"form-control txt\">\n");
      out.write("                        <div id=\"error5\" class=\"errores  \"> Debe digitar su Celular</div>\n");
      out.write("                        <div id=\"error55\" class=\"errores  \"> Solo se permiten numeros</div><br><br>\n");
      out.write("\n");
      out.write("                        <!-- Direccion -->\n");
      out.write("                        <label id=\"lb6\" class=\"label\">Direccion</label>\n");
      out.write("                        <input id=\"txtdireccion\" name=\"Direccion\" type=\"text\" name=\"text\" class=\"form-control txt\" onkeyup=\"quitar();\" placeholder=\"Digite su direccion\">\n");
      out.write("                        <div id=\"error6\" class=\"errores \"> Debe digitar su Direccion</div><br><br>\n");
      out.write("\n");
      out.write("                        <!-- Correo -->\n");
      out.write("                        <label id=\"lb7\" class=\"label\">Correo</label>\n");
      out.write("                        <input type=\"text\" name=\"Correo\" id=\"txtcorreo\" onkeyup=\"quitar();\" class=\"form-control txt\" placeholder=\"Digite su correo\">\n");
      out.write("                        <div id=\"error7\" class=\"errores  \"> Debe digitar su Correo electronico</div>\n");
      out.write("                        <div id=\"error77\" class=\"errores  \"> El correo no es valido, verificar</div><br><br>\n");
      out.write("                        <!-- Clave -->\n");
      out.write("                        <label  id=\"lb8\" class=\"label\">Clave</label>\n");
      out.write("                        <input id=\"txtclave\" name=\"Clave\" type=\"text\" name=\"text\"  onkeyup=\"quitar();\"  class=\"form-control txt\" placeholder=\"Digite su clave\"><br><br>\n");
      out.write("                        <div id=\"error8\" class=\"errores  \"> Debe digitar su Contraseña</div>\n");
      out.write("\n");
      out.write("                        <!-- Cargo -->\n");
      out.write("                        <label id=\"lb9\" class=\"label\">Cargo</label>\n");
      out.write("                        <select id=\"txtCargo\" name=\"Cargo\" onclick=\"quitar();\"  class=\"form-control txt\">\n");
      out.write("                            <option value=\"Seleccione\">Selecione</option>\n");
      out.write("                            <option value=\"Admin\">Administrador</option>\n");
      out.write("                            <option value=\"Almacenista\">Almacenista</option> \n");
      out.write("                        </select> <br><br>\n");
      out.write("                        <label id=\"lb2\" class=\"label\">Institucion</label>\n");
      out.write("                        <div id=\"error9\" class=\"errores  \"> Debe seleccionar el cargo correspondiente</div>\n");
      out.write("                        <!-- Institucion -->\n");
      out.write("                        <select name=\"Institu\" class=\"form-control txt\" id=\"txtTipo\">\n");
      ...
      out.write("            <script src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/js/validarCamposRU.js\"></script>\n");
      out.write("    </body>\n");
      out.write("</html>\n");
    } catch (Throwable t) {
